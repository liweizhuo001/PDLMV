...
import aml.filter.RepairMapRefine;
import aml.filter.Repairer;
import aml.filter.RepairerRefined;
...
//Attributes
	...
	private RepairMapRefine repRevised;
...
//Public Methods
	...
	public RepairMapRefine buildRefinedRepairMap()
    {
		repRevised = new RepairMapRefine();
		return repRevised;
    }
	...
	public RepairMapRefine getRefinedRepairMap()
	{
		return repRevised;
	}
	...
	public void removeIncorrect()
	{
		...
		for(Mapping m : a)
		{
			...
			/*if(m.getSimilarity()==0.0)
				continue;*/
			if(!m.getStatus().equals(MappingStatus.INCORRECT)&&m.getSimilarity()!=0.0)	
				reviewed.add(m);
		}
	...
	public void repairRevise()
	{
		im = new InteractionManager();
		repRevised = new RepairMapRefine();
		RepairerRefined r = new RepairerRefined();
		r.RevisedMappings();
		needSave = true;
	}
